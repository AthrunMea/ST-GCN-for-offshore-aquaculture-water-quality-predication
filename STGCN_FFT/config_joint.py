...
class OptInit:
    def __init__(self, logger):
        ...
        # model args
        parser.add_argument('--model_name', type=str, default='stgcn_fft_joint_concat', help='model_name')
