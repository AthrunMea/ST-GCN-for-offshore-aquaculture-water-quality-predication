...
class MRFA(nn.Module):
    def __init__(self, dim):
        ...
        self.ctx_branch_s1 = nn.Sequential(
            ...
            nn.GELU(),
            nn.Conv2d(dim // 4, dim // 4, kernel_size=(1,7), padding=(0, 3), groups=dim // 4)
        )
        # 门控分支与后整形
        ...
        self.ctx_branch_s2 = nn.Sequential(
            ...
            nn.GELU(),
            nn.Conv2d(dim // 2, dim // 2, kernel_size=(1, 9), padding=(0, 4), groups=dim // 2)
        )
        ...
        self.ctx_branch_s3 = nn.Sequential(
            ...
            nn.GELU(),
            nn.Conv2d(dim * 3 // 4, dim * 3 // 4, kernel_size=(1, 11), padding= (0, 5), groups=dim * 3 // 4)
        )
